const local: App.I18n.Schema = {
  ...
  route: {
    ...
    campus: '校园墙+',
    campus_dashboard: '工作台',
    campus_tenant: '租户管理',
    campus_user: '用户管理',
    campus_content: '内容管理',
    campus_content_post: '校园墙帖子',
    campus_content_comment: '评论管理',
    'campus_content_lost-found': '失物招领',
    campus_content_goods: '二手闲置',
    campus_content_help: '校园互助',
    campus_content_activity: '活动社团',
    campus_audit: '审核中心',
    campus_report: '举报管理',
    campus_category: '分类管理',
    campus_notice: '公告管理',
    'campus_sensitive-word': '敏感词管理',
    'campus_operation-log': '操作日志'
  },
  page: {
    login: {
      common: {

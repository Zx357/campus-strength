const local: App.I18n.Schema = {
  ...
  route: {
    ...
    campus: 'Campus Wall+',
    campus_dashboard: 'Dashboard',
    campus_tenant: 'Tenants',
    campus_user: 'Users',
    campus_content: 'Content',
    campus_content_post: 'Posts',
    campus_content_comment: 'Comments',
    'campus_content_lost-found': 'Lost Found',
    campus_content_goods: 'Second Goods',
    campus_content_help: 'Campus Help',
    campus_content_activity: 'Activities',
    campus_audit: 'Audit Center',
    campus_report: 'Reports',
    campus_category: 'Categories',
    campus_notice: 'Notices',
    'campus_sensitive-word': 'Sensitive Words',
    'campus_operation-log': 'Operation Logs'
  },
  page: {
    login: {
      common: {

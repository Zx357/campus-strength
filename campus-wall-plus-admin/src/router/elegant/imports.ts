...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  campus_audit: () => import("@/views/campus/audit/index.vue"),
  campus_category: () => import("@/views/campus/category/index.vue"),
  campus_content_activity: () => import("@/views/campus/content/activity/index.vue"),
  campus_content_comment: () => import("@/views/campus/content/comment/index.vue"),
  campus_content_goods: () => import("@/views/campus/content/goods/index.vue"),
  campus_content_help: () => import("@/views/campus/content/help/index.vue"),
  "campus_content_lost-found": () => import("@/views/campus/content/lost-found/index.vue"),
  campus_content_post: () => import("@/views/campus/content/post/index.vue"),
  campus_dashboard: () => import("@/views/campus/dashboard/index.vue"),
  campus_notice: () => import("@/views/campus/notice/index.vue"),
  "campus_operation-log": () => import("@/views/campus/operation-log/index.vue"),
  campus_report: () => import("@/views/campus/report/index.vue"),
  "campus_sensitive-word": () => import("@/views/campus/sensitive-word/index.vue"),
  campus_tenant: () => import("@/views/campus/tenant/index.vue"),
  campus_user: () => import("@/views/campus/user/index.vue"),

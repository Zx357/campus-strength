...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    meta: {
      title: 'campus',
      i18nKey: 'route.campus'
    },
    children: [
      {
        name: 'campus_audit',
        path: '/campus/audit',
        component: 'view.campus_audit',
        meta: {
          title: 'campus_audit',
          i18nKey: 'route.campus_audit'
        }
      },
      {
        name: 'campus_category',
        path: '/campus/category',
        component: 'view.campus_category',
        meta: {
          title: 'campus_category',
          i18nKey: 'route.campus_category'
        }
      },
      {
        name: 'campus_content',
        path: '/campus/content',
        meta: {
          title: 'campus_content',
          i18nKey: 'route.campus_content'
        },
        children: [
          {
            ...
            meta: {
              title: 'campus_content_activity',
              i18nKey: 'route.campus_content_activity'
            }
          },
          {
            ...
            meta: {
              title: 'campus_content_comment',
              i18nKey: 'route.campus_content_comment'
            }
          },
          {
            ...
            meta: {
              title: 'campus_content_goods',
              i18nKey: 'route.campus_content_goods'
            }
          },
          {
            ...
            meta: {
              title: 'campus_content_help',
              i18nKey: 'route.campus_content_help'
            }
          },
          {
            ...
            meta: {
              title: 'campus_content_lost-found',
              i18nKey: 'route.campus_content_lost-found'
            }
          },
          {
            ...
            meta: {
              title: 'campus_content_post',
              i18nKey: 'route.campus_content_post'
            }
          }
        ]
      },
      {
        name: 'campus_dashboard',
        path: '/campus/dashboard',
        component: 'view.campus_dashboard',
        meta: {
          title: 'campus_dashboard',
          i18nKey: 'route.campus_dashboard'
        }
      },
      {
        name: 'campus_notice',
        path: '/campus/notice',
        component: 'view.campus_notice',
        meta: {
          title: 'campus_notice',
          i18nKey: 'route.campus_notice'
        }
      },
      {
        name: 'campus_operation-log',
        path: '/campus/operation-log',
        component: 'view.campus_operation-log',
        meta: {
          title: 'campus_operation-log',
          i18nKey: 'route.campus_operation-log'
        }
      },
      {
        name: 'campus_report',
        path: '/campus/report',
        component: 'view.campus_report',
        meta: {
          title: 'campus_report',
          i18nKey: 'route.campus_report'
        }
      },
      {
        name: 'campus_sensitive-word',
        path: '/campus/sensitive-word',
        component: 'view.campus_sensitive-word',
        meta: {
          title: 'campus_sensitive-word',
          i18nKey: 'route.campus_sensitive-word'
        }
      },
      {
        name: 'campus_tenant',
        path: '/campus/tenant',
        component: 'view.campus_tenant',
        meta: {
          title: 'campus_tenant',
          i18nKey: 'route.campus_tenant'
        }
      },
      {
        name: 'campus_user',
        path: '/campus/user',
        component: 'view.campus_user',
        meta: {
          title: 'campus_user',
          i18nKey: 'route.campus_user'
        }
      }
    ]
  },
